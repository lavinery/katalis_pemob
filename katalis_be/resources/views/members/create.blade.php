<x-app-layout>
    <div class="min-h-screen bg-gray-50/50 p-8">
        <div class="max-w-2xl mx-auto">
            <div class="mb-8">
                <h1 class="text-2xl font-semibold text-gray-900">{{ __('Add New Member') }}</h1>
                <p class="mt-1 text-sm text-gray-500">Add a new member to the organization</p>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="batch_year" name="batch_year" type="number"
                                class="mt-1.5 block w-full rounded-xl border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20"
                                :value="old('batch_year')" required min="2000" max="{{ date('Y') }}" />
                        ...
                        <div>
                            ...
                            <select name="faculty" id="faculty"
                                ...
                                <option value="Fakultas Teknik"
                                    {{ old('faculty') == 'Fakultas Teknik' ? 'selected' : '' }}>
                                    Fakultas Teknik
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="study_program" id="study_program"
                                ...
                                <option value="Informatika"
                                    {{ old('study_program') == 'Informatika' ? 'selected' : '' }}>
                                    Informatika
                                </option>
